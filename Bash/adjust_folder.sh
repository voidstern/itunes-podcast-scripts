...
# Convert Input Directory to Absolute Path to ensure find outputs full paths
...
echo "${BOLD}${CYAN}Directory:${RESET} $INPUT_DIR_ABS"
if [[ -n "$FORCE_FLAG" ]]; then
  echo "${BOLD}${YELLOW}Mode:${RESET} Force enabled"
fi
